...
### ⛔ CORE always-on — mở `SKILL.md` NGAY, trước tool call đầu tiên (thứ tự = ưu tiên, đọc top-down)
  ...
  _(no core skills — run `ckit harness init`)_
...
- _(none — add via `ckit skill add <github-url>`)_
<!-- ckit:skills:end -->
