> **NOTE:** This is the upstream `colbymchenry/codegraph` README, bundled for reference only.

> Day-to-day usage rules for AI inside ckit are in `../SKILL.md`. Read those first.

> The text below is verbatim from <https://github.com/colbymchenry/codegraph>.
